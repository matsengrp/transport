...
from common.params import DEFAULT_LAMBDA, DEFAULT_NEIGHBOR_RADIUS, DMAX, SPECIES_DB
...
class TCRScorer():
    def __init__(self, file_1, file_2, species, distribution_type="uniform", lambd=DEFAULT_LAMBDA, neighbor_radius=DEFAULT_NEIGHBOR_RADIUS):
        ...
        self.dist_mat = TCRDist(species=species, species_db=db).get_raw_distance_matrix(
