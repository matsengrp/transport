...
class TCRMultiClusterer():
    def __init__(self, file_1, file_2, species, outdir, max_cluster_count=10):
        ...
        initial_clusterer = TCRClusterer(self_distance_matrix=initial_rep_2_self_dist_mat, score_dict=initial_score_dict, species=self.species, cluster_label="cluster_1", outdir=cluster_outdir)
    ...
    def run_clustering_step(self, file_1, file_2, cluster_label, score_dict=None, cluster_outdir=None):
        ...
        tcr_clusterer = TCRClusterer(self_distance_matrix=rep_2_self_dist_mat, score_dict=score_dict, species=self.species, cluster_label=f"cluster_{cluster_label}", outdir=cluster_outdir)
